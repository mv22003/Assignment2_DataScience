...
4. [feature_extraction.py](Assignment2_DataScience/feature_extraction.py) --> Python file that contains a series of functions that automatizes the feature extraction of both the control and test group of the dataset.
