...
9. 
10. [rfe_models_test.ipynb](rfe_models_test.ipynb) ---> Jupyter Notebook that contains the Recursive Feature Elimination process using the best predictor from [models_test](models_test.ipynb)
